    ...
    <div class="sidebar">
            ...
            <a class="logo-expand" href="{{ route('director.index') }}">TaskFlow</a>
            <div class="side-wrapper">
                <div class="side-title">MENU</div>
                    <div class="side-menu">
                    <a class="sidebar-link discover" href="{{ route('director.index') }}">
                    ...
                    <a class="sidebar-link" href="{{ route('director.indexClients') }}">
                    <svg viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a class="sidebar-link" href="{{ route('director.settings') }}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
