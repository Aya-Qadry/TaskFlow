...
<body>
        ...
        <div class="main-header anim" style="--delay: 0s">Update Your Project  </div>
                    ...
                    <div class="">
                        <div class="card">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="due_date" name="due_date" value="{{ $project->due_date }}" required>
                            </div>
