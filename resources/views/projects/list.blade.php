...
<head>
    ...
    <link  href="{{asset('assets/css/list.css')}}" rel="stylesheet" type="text/css"> 
</head>
<body>
        <div class="container">
                            ...
                            <tbody>
                                @forelse ($projects as $project)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('storage/' . $project->logo) }}" alt="{{ $project->name }} Logo" class="project-logo">
                                        </td>
                                        <td>{{ $project->name }}</td>
        ...
        <div class="modal fade" id="projectModal" tabindex="-1" role="dialog" aria-labelledby="projectModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <center>
                    <img id="modal-logo" src="" alt="Project's Logo" class="logo " style="width : 200px ; height :160px;">
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
            ...
            <script>
                ...
                $('#projectModal').on('show.bs.modal', function (event) {
                    ...
                    var logo = button.closest('tr').find('img').attr('src'); // Get the profile picture URL from the table
